...
s.bind((socket.gethostname(), 2010))
# s.bind((socket.gethostname(), 7474))
...
def parse_opt():
    ...
    parser.add_argument('--source', default='change here to ukraine viedo link', help='file/dir/URL/glob, 0 for webcam') # me added
