...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # Save results (image with detections) # comment outed
            # if save_img:
...
def parse_opt():
    ...
    parser.add_argument('--source', default='https://youtu.be/HpdO5Kq3o7Y', help='file/dir/URL/glob, 0 for webcam') # me added
