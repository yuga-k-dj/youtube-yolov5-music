...
def run(config_map, recv_msg): #def run(config_map)
      ...
      if not tensors:
        ...
        for i, ns in enumerate(config.data_converter.from_tensors(tensors)):
          note_seq.sequence_proto_to_midi_file(
              ...
              ns, output_dir + 'brazil' + str(i) + '.mid')
        # print(
  ...
  for i, ns in enumerate(results):
    ...
    note_seq.sequence_proto_to_midi_file(ns, output_dir + 'brazil' + str(i) + '.mid')
  
  print(results)

  midi = midi_file_to_note_sequence(output_dir + 'brazil' + str(i) + '.mid')
